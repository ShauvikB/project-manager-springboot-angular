...
public class UserContollerTest {
	...
	public void testGetUsers() throws Exception {
		...
		given(serviceMock.getAll()).willReturn(Arrays.asList(createUser("shauvik")));
		
		User t = createUser("shauvik");
		Arrays.asList(createUser("shauvik"));
	...
	public void testGetUser() throws Exception {
		...
		given(serviceMock.get(Long.valueOf(1))).willReturn(createUser("shauvik"));
